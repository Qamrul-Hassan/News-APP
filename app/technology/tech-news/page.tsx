          ...
          {articles.map((article, idx) => (
            <article key={idx} className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col group">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <a href={article.url} target="_blank" rel="noopener noreferrer" className="inline-block text-purple-600 font-semibold hover:underline mt-auto">Read Full Story →</a>
              </div>
            </article>
          ))}
        </section>
